...
массив (количество строк и столбцов одинаковое), и с помощью цикла(-ов) заполнить его
...
одномерный целочисленный массив, метод должен вернуть true, если в
...
8. *** Написать метод, которому на вход подается одномерный массив и число n
 ...
 элементы массива на n позиций. Элементы смещаются циклично. Для усложнения задачи нельзя пользоваться
...
public class lesson3 {
    ...
    public static void replacingdigits() {
    ...
    public static void containerdos100() {
        int[] arr = new int[100];
    ...
    public static void twodimensionalmasiv() {
        int[][] arr = new int[5][5];
        arr[0][0] = 1;
        arr[1][1] = 1;
        arr[2][2] = 1;
    ...
    public static int[] generation(int len, int initialValue) {
        int arr[] = new int[len];
        for (int i = 0; i < arr.length; i++) {
            arr[i] = initialValue;
        }
